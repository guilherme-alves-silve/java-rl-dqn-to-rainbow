 ...
 * </ol>
 *
 * <p>The online and target networks must be {@link CategoricalQNoisyNetworkMLP} instances so that
...
public class AgentC51NoisyNetDQN extends AbstractAgent {
    ...
    public AgentC51NoisyNetDQN(float epsilon,
        ...
        if (!(onlineNet instanceof CategoricalQNoisyNetworkMLP)) {
        ...
        this.atomsBroadcaster = this.targetCatNoisyNet.newAtomsBroadcaster(subManager);
    }
